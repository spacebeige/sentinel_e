/**
 * FeaturesSection — Figma Feature Module (ported from figma_ui)
 * 6 feature cards with gradient icons and hover animations.
 * Standalone — not wired into the chat engine.
 */
import React from 'react';
import { motion } from 'framer-motion';
import { MessageSquare, Layers, Palette, Globe, Lock, Cpu } from 'lucide-react';
