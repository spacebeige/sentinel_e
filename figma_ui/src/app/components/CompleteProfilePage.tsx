...
//
// Responsibilities:
//   - Accept display name input
//   - Update user profile via Supabase
//   - On success → navigate to /chat directly in handler
//
// No useEffect reactive navigate race.
// ============================================================
      ...
      >
        <div className="text-center mb-8">
          ...
          <p style={{ color: isDark ? 'rgba(255,255,255,0.45)' : 'rgba(0,0,0,0.5)' }}>
            How should Sentinel-E address you?
          </p>
        </div>
        ...
        >
          ...
          <form onSubmit={handleCompleteProfile} className="space-y-4 relative z-10">
            <div>
            ...
            <button
              type="button"
              onClick={skipProfile}
              className="w-full text-center text-[13px] font-medium mt-4 hover:underline"
